...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <table class="table table-hover">
      <thead><tr><th>User</th><th class="text-center">Creator</th><th class="text-center">Reviewer</th><th class="text-center">Approver</th><th class="text-center">Publisher</th><th class="text-center">Admin</th><th></th></tr></thead>
      <tbody>
      @foreach($users as $u)
      ...
      <tr>
        ...
        <td class="text-center"><input type="checkbox" name="admin" value="1" @checked($u->roles['admin'] ?? false) title="Can manage Users & Roles and Workflow rules"></td>
